...
unsigned char guchSSIDName[]= "minimum";  // Name of the ssid ..Hotspot name
unsigned char guchSSIDPassword[] = "minimum8";// Password of Network
...
unsigned  char API_POSTkey[]="9YSZI1BTSOT2V6LO";  /// API key for indiviaul channels

unsigned char guchChannelNumber[8]="1035663"; // channnel number 
